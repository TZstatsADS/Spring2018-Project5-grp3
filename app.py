...
def get_menu():
    menu = html.Div([
                     ...
                     dcc.Link('Similarity', href='/Similarity', className="tab",
                              ...
                              'borderStyle': 'solid','borderRadius':'5px','border-color': '#B8B8B8','float':'left'}),
                     
                     dcc.Link('Attributes', href='/Attributes', className="tab",
                              style = {'background-color': '#FFFFFF','font-size':'20px','color': colors['text'],
                                       'padding': '12px 25px','width':'29%','text-align': 'center',
                                       'text-decoration':'none','display': 'inline-block','borderWidth': '1px',
                              'borderStyle': 'solid','borderRadius':'5px', 'border-color': '#B8B8B8','float':'center','position':'absolute'}),
                     
                     dcc.Link('Contact Info', href='/Contact',className="tab",
                              style = {'background-color': '#FFFFFF','font-size':'20px','color': colors['text'],
                                       'padding': '12px 25px','width':'30%','text-align': 'center',
                                       'text-decoration':'none','display': 'inline-block','borderWidth': '1px',
                              'borderStyle': 'solid','borderRadius':'5px', 'border-color': '#B8B8B8','float':'right'})
